...
public final class ToastUtils {
    ...
    private static int yOffset         = (int) (64 * Util.getContext().getResources().getDisplayMetrics().density + 0.5);
     ...
     * @param layoutId 视图
     */
    private static void setView(@LayoutRes final int layoutId) {
        LayoutInflater inflate = (LayoutInflater) Util.getContext().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        sViewWeakReference = new WeakReference<>(inflate != null ? inflate.inflate(layoutId, null) : null);
    }
     ...
     * @param view 视图
     */
    private static void setView(final View view) {
    ...
    private static void show(@StringRes final int resId, final int duration) {
        show(Util.getContext().getResources().getText(resId).toString(), duration);
    }
    ...
    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        show(String.format(Util.getContext().getResources().getString(resId), args), duration);
    }
    ...
    private static void show(final CharSequence text, final int duration) {
        ...
        if (sViewWeakReference != null) {
            final View view = sViewWeakReference.get();
            if (view != null) {
                sToast = new Toast(Util.getContext());
                sToast.setView(view);
        ...
        if (!isCustom) {
            if (messageColor != DEFAULT_COLOR) {
                ...
                sToast = Toast.makeText(Util.getContext(), spannableString, duration);
            } else {
